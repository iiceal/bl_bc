cmd_boot/main.o := arm-eabi-gcc -Wp,-MD,boot/.main.o.d  -nostdinc -isystem /opt/gcc/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/include  -march=armv7-a -mthumb -mno-thumb-interwork -fno-stack-protector -fno-builtin -ffreestanding -fno-exceptions -fno-non-call-exceptions -Wall -Werror -Wstrict-prototypes -include include/generated/autoconf.h -DHGVERSION=\"2ff606f7\" -DHGBUILDDATE=\"2019-10-23\" -mfloat-abi=hard -mfpu=vfpv4-d16 -fno-unwind-tables -Os -I./chip/bp2016/include/ -I./include/ -I./include/asm/    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(main)"  -D"KBUILD_MODNAME=KBUILD_STR(main)" -c -o boot/main.o boot/main.c

source_boot/main.o := boot/main.c

deps_boot/main.o := \
    $(wildcard include/config/enable/trace.h) \
    $(wildcard include/config/cmd/shell.h) \
    $(wildcard include/config/upv/serial.h) \
    $(wildcard include/config/drv/uart.h) \
    $(wildcard include/config/boot/count/down.h) \
    $(wildcard include/config/boot/count/down/sec.h) \
    $(wildcard include/config/auto/upgrade.h) \
    $(wildcard include/config/auto/upgrade/delay/ms.h) \
    $(wildcard include/config/fastboot.h) \
    $(wildcard include/config/board/name.h) \
    $(wildcard include/config/common/malloc.h) \
    $(wildcard include/config/sys/malloc/start.h) \
    $(wildcard include/config/sys/malloc/leln.h) \
    $(wildcard include/config/sys/malloc/len.h) \
    $(wildcard include/config/build/enable/unwind.h) \
  include/common.h \
