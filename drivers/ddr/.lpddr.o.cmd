cmd_drivers/ddr/lpddr.o := arm-eabi-gcc -Wp,-MD,drivers/ddr/.lpddr.o.d  -nostdinc -isystem /opt/gcc/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/include  -march=armv7-a -mthumb -mno-thumb-interwork -fno-stack-protector -fno-builtin -ffreestanding -fno-exceptions -fno-non-call-exceptions -Wall -Werror -Wstrict-prototypes -include include/generated/autoconf.h -DHGVERSION=\"2ff606f7\" -DHGBUILDDATE=\"2019-10-23\" -mfloat-abi=hard -mfpu=vfpv4-d16 -fno-unwind-tables -Os -I./chip/bp2016/include/ -I./include/ -I./include/asm/    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(lpddr)"  -D"KBUILD_MODNAME=KBUILD_STR(lpddr)" -c -o drivers/ddr/lpddr.o drivers/ddr/lpddr.c

source_drivers/ddr/lpddr.o := drivers/ddr/lpddr.c

deps_drivers/ddr/lpddr.o := \
    $(wildcard include/config/lpddr.h) \
    $(wildcard include/config/bp2016/oem.h) \
...
drivers/ddr/lpddr.o: $(deps_drivers/ddr/lpddr.o)
