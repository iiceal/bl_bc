cmd_drivers/qspi/flash.o := arm-eabi-gcc -Wp,-MD,drivers/qspi/.flash.o.d  -nostdinc -isystem /opt/gcc/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/include  -march=armv7-a -mthumb -mno-thumb-interwork -fno-stack-protector -fno-builtin -ffreestanding -fno-exceptions -fno-non-call-exceptions -Wall -Werror -Wstrict-prototypes -include include/generated/autoconf.h -DHGVERSION=\"2ff606f7\" -DHGBUILDDATE=\"2019-10-23\" -mfloat-abi=hard -mfpu=vfpv4-d16 -fno-unwind-tables -Os -I./chip/bp2016/include/ -I./include/ -I./include/asm/    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(flash)"  -D"KBUILD_MODNAME=KBUILD_STR(flash)" -c -o drivers/qspi/flash.o drivers/qspi/flash.c

source_drivers/qspi/flash.o := drivers/qspi/flash.c

deps_drivers/qspi/flash.o := \
    $(wildcard include/config/qspi/dma/transfer.h) \
    $(wildcard include/config/qspi/s25fl512s.h) \
    $(wildcard include/config/qspi/w25q256fv.h) \
    $(wildcard include/config/qspi/gd25q512mc.h) \
    $(wildcard include/config/qspi/gd25q256d.h) \
  ...
  drivers/qspi/fl_common_cmd.h \
  chip/bp2016/include/regs/qspi.h \

drivers/qspi/flash.o: $(deps_drivers/qspi/flash.o)
