cmd_drivers/dma/dma_if.o := arm-eabi-gcc -Wp,-MD,drivers/dma/.dma_if.o.d  -nostdinc -isystem /opt/gcc/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/include  -march=armv7-a -mthumb -mno-thumb-interwork -fno-stack-protector -fno-builtin -ffreestanding -fno-exceptions -fno-non-call-exceptions -Wall -Werror -Wstrict-prototypes -include include/generated/autoconf.h -DHGVERSION=\"2ff606f7\" -DHGBUILDDATE=\"2019-10-23\" -mfloat-abi=hard -mfpu=vfpv4-d16 -fno-unwind-tables -Os -I./chip/bp2016/include/ -I./include/ -I./include/asm/    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(dma_if)"  -D"KBUILD_MODNAME=KBUILD_STR(dma_if)" -c -o drivers/dma/dma_if.o drivers/dma/dma_if.c

source_drivers/dma/dma_if.o := drivers/dma/dma_if.c

deps_drivers/dma/dma_if.o := \
  ...
  include/timer.h \
  include/crc.h \
  drivers/dma/dma_imp.h \
  chip/bp2016/include/regs/dma.h \
  include/drivers/drv_dma.h \
  include/cp15.h \

drivers/dma/dma_if.o: $(deps_drivers/dma/dma_if.o)
