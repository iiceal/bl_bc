cmd_chip/bp2016/bp2016_chip.o := arm-eabi-gcc -Wp,-MD,chip/bp2016/.bp2016_chip.o.d  -nostdinc -isystem /opt/gcc/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/include  -march=armv7-a -mthumb -mno-thumb-interwork -fno-stack-protector -fno-builtin -ffreestanding -fno-exceptions -fno-non-call-exceptions -Wall -Werror -Wstrict-prototypes -include include/generated/autoconf.h -DHGVERSION=\"2ff606f7\" -DHGBUILDDATE=\"2019-10-23\" -mfloat-abi=hard -mfpu=vfpv4-d16 -fno-unwind-tables -Os -I./chip/bp2016/include/ -I./include/ -I./include/asm/    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(bp2016_chip)"  -D"KBUILD_MODNAME=KBUILD_STR(bp2016_chip)" -c -o chip/bp2016/bp2016_chip.o chip/bp2016/bp2016_chip.c

source_chip/bp2016/bp2016_chip.o := chip/bp2016/bp2016_chip.c

deps_chip/bp2016/bp2016_chip.o := \
    $(wildcard include/config/drv/ddr.h) \
    $(wildcard include/config/drv/clk.h) \
    $(wildcard include/config/drv/iomux.h) \
    $(wildcard include/config/dbg/serial/num.h) \
    $(wildcard include/config/upv/serial.h) \
    ...
    $(wildcard include/config/upv/serial/baudrate.h) \
    $(wildcard include/config/mmu/enable.h) \
    $(wildcard include/config/use/irq.h) \
    $(wildcard include/config/drv/dma.h) \
  include/common.h \
  ...
  include/drivers/iomux/iomux_hw_spi.h \
  include/drivers/iomux/iomux_hw_pwm.h \
  include/drivers/iomux/iomux_hw_gpio.h \
  include/drivers/iomux/iomux_hw_if.h \
  include/drivers/drv_qspi.h \
    $(wildcard include/config/qspi/trace.h) \
    $(wildcard include/config/qspi/dma/transfer.h) \
  include/drivers/drv_clk.h \

chip/bp2016/bp2016_chip.o: $(deps_chip/bp2016/bp2016_chip.o)
